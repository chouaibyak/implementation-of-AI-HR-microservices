  ...
  return (
    <div className='fixed h-screen border shadow-accent w-65 p-3.5 bg-white py-17'>
      ...
      <ul>
        ...
        <li onClick={() => onNavigate("candidates")} className='flex items-center gap-2 p-2 w-full hover:bg-gray-100 cursor-pointer'><Users size={18} /> Mes candidatures</li>
      </ul>

      {/* Second group */}
      <ul className='mt-4 border-t'>
        <li onClick={() => onNavigate("matches")} className='flex items-center gap-2 p-2 w-full hover:bg-gray-100 cursor-pointer'><Handshake size={18} /> Offres d'emploi</li>
